main() {
  ...
  print(simpleNumber.toRadixString(
      16)); // prints the "hexadecimal" representation of 100(decimal).

  print(simpleFractional
      .toStringAsExponential()); // prints the "exponential" representation of 0.0001(fractional).
}
